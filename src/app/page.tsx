    ...
    <main className="min-h-screen bg-black text-white">
      <section className="text-center py-32 px-6 max-w-5xl mx-auto">
        ...
        <p className="text-xl text-gray-300 leading-relaxed max-w-3xl mx-auto">
          ...
          MAP-compliant distribution, optimized listings, and data-driven
          advertising strategies.
        </p>

        <p className="text-sm text-gray-500 mt-4">
          Operating exclusively through authorized wholesale accounts. No
          arbitrage. No gray market sourcing.
        </p>
      ...
      <section className="py-20 border-t border-gray-800 text-center max-w-4xl mx-auto">
        ...
        <p className="text-gray-300 leading-relaxed">
          We are a U.S.-registered, tax-compliant retail firm dedicated to
          building long-term relationships with brand owners and authorized
          distributors. We integrate into your supply chain as a reliable,
          process-driven extension of your sales team.
        </p>
      </section>

      <section className="py-20 border-t border-gray-800 text-center max-w-4xl mx-auto">
        <h2 className="text-3xl mb-6">
          Beyond Transactional. Truly Partnership-Driven.
        </h2>

        <p className="text-gray-300 leading-relaxed">
          Our model is built on authorization and alignment. We operate
          exclusively through formal wholesale accounts, ensuring every unit
          sold is documented, authentic, and compliant with your brand’s vision.
        </p>
      </section>
      ...
      <section className="py-24 border-t border-gray-800 text-center max-w-4xl mx-auto">
        ...
        <p className="text-gray-300 leading-relaxed">
          Our primary channel is Amazon FBA (Professional Seller Tier). We
          begin with a structured "Launch & Scale" model, then expand into
          multi-channel environments as performance data validates growth.
        </p>
      </section>
      ...
      <section className="py-20 border-t border-gray-800 text-center">
        <h2 className="text-2xl mb-6">Controlled Distribution Policy</h2>

        <p className="text-gray-400 max-w-3xl mx-auto leading-relaxed">
          Ocean Global Ventures does not operate on unauthorized marketplaces,
          discount platforms, liquidation channels, or peer-to-peer resale
          environments.
        </p>
      </section>
      ...
      <section className="py-32 text-center">
        ...
        <a
          href="/contact"
          className="bg-yellow-500 text-black px-10 py-4 rounded-lg font-semibold hover:bg-yellow-400 transition"
        >
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <div className="bg-gray-900 p-8 rounded-lg border border-gray-800">
              ...
              <p className="text-gray-300">
                Professional representation of your products across major online
                marketplaces with consistent brand presentation.
              </p>
            </div>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center px-6">
          ...
          <div className="grid gap-6">
            ...
            <div className="bg-gray-900 p-6 rounded-lg border border-gray-800">
              ...
              <p className="text-gray-300 text-sm">
                Listings are optimized to ensure accurate product representation
